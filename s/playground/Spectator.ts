...
export default class Spectator extends Entity {
  ...
  static makeCamera({scene, position}: {scene: Scene, position: [number, number, number]}) {
  ...
  static logic({tick, camera, watcher}: {tick: Tick, camera: FreeCamera, watcher: Watcher}) {
